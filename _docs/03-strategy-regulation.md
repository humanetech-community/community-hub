---
title: "Strategic Pillar: Public Pressure"
permalink: /strategy/regulation/
...
Consult the [JavaScript documentation]({{ site.baseurl }}{% link _docs/02-strategy-awareness.md %}) for more information on working with theme scripts.
{: .notice--info}
